...
from ox1audio_ml_worker.embedders.provider import ModelProvider
from ox1audio_ml_worker.vector.ranking import (
    ScoredTrack,
...
def collection_name(provider: str, version: str) -> str:
    value = re.sub(r"[^a-zA-Z0-9_-]+", "_", f"ox1audio_{provider}_{version}")
    return value[:120]
