...
async def _tracks_payload(
    ...
    for track_id in track_ids:
        ...
        payload.append(track_payload(track))
...
async def list_playlists(ctx: ToolContext, _args: ListPlaylistsArgs) -> ToolResult:
    ...
    playlist_ids = [str(summary.playlist.id) for summary in summaries]
    return ToolResult(
        payload={
            "playlists": [
                {
...
def register_tools() -> None:
    registry.register(
        ToolSpec(
            name="list_playlists",
            description="List the current user's playlists (attached as playlist widgets).",
    ...
    registry.register(
        ToolSpec(
            ...
            description=(
                ...
                "Call this when the user asks to create, build, or make a playlist/mix. "
                "The playlist is attached as a UI widget."
            ),
    ...
    registry.register(
        ToolSpec(
            ...
            description="Rename a playlist or update/clear its description.",
